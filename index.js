...
*/
console.log(`"${reviews[5].name} gave the restaurant a ${reviews[5].rating} star review, and their feedback was: ${reviews[5].feedback}"`)
...
*/
reviews.push({name: 'Mike', rating: 1, feedback: 'Cant seem to pass the autograder'} )
console.log(reviews)
...
function getReviewByIndex(array, i) {
  let print = `" ${array[i].name} gave the restaurant a ${array[i].rating} star review, and their feedback was: ${array[i].feedback}"`;
  return print 
}

console.log('test', getReviewByIndex(reviews, 2)); 
